...
static void tryStoreReferenceData() {
    ...
    const int32_t p0_pa   = (int32_t)(Sensors::getGroundPressure());
...
void setup() {
    ...
    FC::setRecovered(recoveredInFlight);
    ...
    Sensors::init(recoveredInFlight);
    FC::init();
    ...
    if (recoveredInFlight) {
        ...
        if (bootRecoveredState == Proto::STATE_POWERED_FLIGHT) {
            FC::beginPoweredFlight(micros());
        }
